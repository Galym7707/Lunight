document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        ...
        kz: {
            ...
            portfolio_title: "Біздің Портфолио", portfolio_desc_mpox: "Медициналық суреттер бойынша маймыл шешегін анықтау үшін ЖИ негізіндегі жүйе.", portfolio_desc_sami: "Арт-студияға арналған жарқын және креативті сайт.", portfolio_desc_legal: "Қазақстандағы құқықтық сұрақтарға жылдам жауап беретін ЖИ заңгер көмекшісі.", portfolio_desc_rooflux: "Алматыдағы шатыр материалдарын жеткізушіге арналған лендинг.", portfolio_view: "Жобаны көру",
