document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        en: {
            ...
            portfolio_title: "Our Portfolio", portfolio_desc1: "A landing page for a modern tech startup.", portfolio_desc2: "Corporate website for a major financial group.", portfolio_desc3: "E-commerce store for a popular fashion brand.", portfolio_desc4: "A web application for project management.", portfolio_view: "View Project",
        ...
        ru: {
            ...
            portfolio_title: "Наше Портфолио", portfolio_desc1: "Лендинг для современного технологического стартапа.", portfolio_desc2: "Корпоративный сайт для крупной финансовой группы.", portfolio_desc3: "Интернет-магазин для популярного модного бренда.", portfolio_desc4: "Веб-приложение для управления проектами.", portfolio_view: "Посмотреть проект",
        ...
        kz: {
            ...
            portfolio_title: "Біздің Портфолио", portfolio_desc1: "Заманауи технологиялық стартапқа арналған лендинг.", portfolio_desc2: "Ірі қаржы тобына арналған корпоративтік сайт.", portfolio_desc3: "Танымал сән брендіне арналған интернет-дүкен.", portfolio_desc4: "Жобаларды басқаруға арналған веб-қосымша.", portfolio_view: "Жобаны қарау",
